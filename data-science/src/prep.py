...
def parse_args():
    ...
    parser.add_argument("--test_train_ratio", type=float, default=0.3, help="Test-train ratio")  # Specify the type (float) and default value (0.2) for test-train ratio
...
def main(args):  # Write the function name for the main data preparation logic
    ...
    train_df, test_df = train_test_split(df, test_size=args.test_train_ratio, random_state=65)
